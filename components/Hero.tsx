...
const Hero: React.FC = () => {
  return (
    <div id="home" className="relative bg-white overflow-hidden pt-20 lg:pt-28 pb-16">
      {/* Background decoration */}
      <div className="absolute inset-0 z-0 bg-grid-pattern opacity-40"></div>
      <div className="absolute top-0 right-0 -mt-20 -mr-20 w-96 h-96 bg-blue-100 rounded-full blur-3xl opacity-50 animate-pulse"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center justify-center">
          ...
          <div className="sm:text-center md:max-w-3xl md:mx-auto lg:col-span-12 lg:text-center animate-fade-in-up">
            ...
            <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center">
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  ...
                  className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-full text-white bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-500/30 transition-all hover:-translate-y-1"
                >
                  资料准备流程 <ArrowRight className="ml-2 h-5 w-5" />
                </a>
              </div>
            </div>
          </div>
